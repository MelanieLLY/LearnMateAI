    ...
    <div className="space-y-6">
      ...
      <div className="bg-brand-50/50 rounded-xl p-5 border border-brand-100 shadow-sm">
        <h4 className="font-semibold text-brand-800 mb-3 flex items-center gap-2">
          <span>📚</span> Instructor Assessments
        </h4>
        {instructorQuizzes.length === 0 ? (
          <p className="text-slate-500 text-sm">No instructor assigned quizzes</p>
        ) : (
      ...
      <div>
        ...
        {studentQuizzes.length === 0 ? (
          <p className="text-slate-500 text-sm italic">No self-practice quizzes generated yet...</p>
        ) : (
          <div className="space-y-3">
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">
                    Difficulty: {quiz.difficulty_level} • {quiz.questions.length} Questions
                  </p>
                </div>
